...
oSNP2eGenes <- function(data, include.QTL=NA, QTL.customised=NULL, GR.Gene="UCSC_knownGene", cdf.function=c("empirical","exponential"), plot=FALSE, verbose=TRUE, placeholder=NULL, guid=NULL)
{
