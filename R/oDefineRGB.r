...
#' df <- oDefineRGB(data, include.RGB="PCHiC_PMID27863249_Monocytes", GR.SNP="dbSNP_Common", placeholder=placeholder)
#' head(df)
#'
#' # c) extract HiC-gene pairs given a list of AS SNPs
#' df_all <- oDefineRGB(include.RGB="PCHiC_PMID27863249_Monocytes", GR.SNP="dbSNP_Common", placeholder=placeholder)
#' }

oDefineRGB <- function(data=NULL, entity=c("SNP","chr:start-end","data.frame","bed","GRanges"), include.RGB=NA, GR.SNP="dbSNP_Common", verbose=TRUE, placeholder=NULL, guid=NULL)
{
