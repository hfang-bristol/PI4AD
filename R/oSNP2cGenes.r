...
oSNP2cGenes <- function(data, entity=c("SNP","chr:start-end","data.frame","bed","GRanges"), include.RGB=NA, GR.SNP="dbSNP_Common", GR.Gene="UCSC_knownGene", cdf.function=c("empirical","exponential"), verbose=TRUE, placeholder=NULL, guid=NULL)
{
